...
contract('Data Market Write Methods Test', function() {
    ...
    it("variable 'description' should be changed from 'leerer Feed' to 'test' by "+web3.eth.accounts[4], function() {
        var contract;
        return DataMarket.deployed().then(function(instance) {
            ...
            return contract.setDescription("test",{from: web3.eth.accounts[4]});
    ...
    it("variable 'description' should NOT be changed from 'test' to 'test2' by "+web3.eth.accounts[3], function() {
        var contract;
        return DataMarket.deployed().then(function(instance) {
            contract = instance;
            ...
            return contract.setDescription("test2",{from: web3.eth.accounts[3]});
